...
void Whiteflower_ExpertFighter_OnMapStart_NPC()
{
...
methodmap Whiteflower_ExpertFighter < CClotBody
{
	...
	{
		Whiteflower_ExpertFighter npc = view_as<Whiteflower_ExpertFighter>(CClotBody(vecPos, vecAng, COMBINE_CUSTOM_MODEL, "1.15", "1000", ally, false,_,_,_,_));
