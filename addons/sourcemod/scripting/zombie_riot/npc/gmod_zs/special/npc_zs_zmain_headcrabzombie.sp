...
public void ZSMainHeadcrabZombie_OnMapStart_NPC()
{
	...
	strcopy(data.Plugin, sizeof(data.Plugin), "npc_zs_zmain_headcrabzombie");
...
{
	return ZSMainHeadcrabZombie(vecPos, vecAng, team);
}

methodmap ZSMainHeadcrabZombie < CClotBody
{
	...
	public ZSMainHeadcrabZombie(float vecPos[3], float vecAng[3], int ally)
	{
		ZSMainHeadcrabZombie npc = view_as<ZSMainHeadcrabZombie>(CClotBody(vecPos, vecAng, "models/zombie/classic.mdl", "1.15", "6000", ally, false));
		...
		*/
		...
		func_NPCDeath[npc.index] = ZSMainHeadcrabZombie_NPCDeath;
		func_NPCThink[npc.index] = ZSMainHeadcrabZombie_ClotThink;
...
public void ZSMainHeadcrabZombie_ClotThink(int iNPC)
{
	ZSMainHeadcrabZombie npc = view_as<ZSMainHeadcrabZombie>(iNPC);
...
//	PrintToChatAll("%.f",GetEntPropFloat(view_as<int>(iNPC), Prop_Data, "m_speed"));
	...
	if(IsValidEnemy(npc.index, npc.m_iTarget))
	{
		...
		ZSMainHeadcrabZombie_AnnoyingZmainwalkLogic(npc,GetGameTime(npc.index), flDistanceToTarget, IsAbuildingNearMe); 
		ZSMainHeadcrabZombie_SelfDefense(npc,GetGameTime(npc.index), npc.m_iTarget, flDistanceToTarget); 
...
void ZSMainHeadcrabZombie_AnnoyingZmainwalkLogic(ZSMainHeadcrabZombie npc, float gameTime, float distance, int IsAbuildingNearMe)
{
...
void ZSMainHeadcrabZombie_SelfDefense(ZSMainHeadcrabZombie npc, float gameTime, int target, float distance)
{
...
public void ZSMainHeadcrabZombie_NPCDeath(int entity)
{
	ZSMainHeadcrabZombie npc = view_as<ZSMainHeadcrabZombie>(entity);
	if(!npc.m_bGib)
	{
		npc.PlayDeathSound();	
	}
