...
static const char g_HealSound[] = "items/medshot4.wav";

public void Bonemesh_OnMapStart_NPC()
{
	NPCData data;
...
static void BonemeshSelfDefense(Bonemesh npc, float gameTime)
{
...
static Action Bonemesh_OnTakeDamage(int victim, int &attacker, int &inflictor, float &damage, int &damagetype, int &weapon, float damageForce[3], float damagePosition[3], int damagecustom)
{
...
static void Bonemesh_NPCDeath(int entity)
{
