...
public void InfectedKamikaze_OnMapStart_NPC()
{
	NPCData data;
...
static void InfectedKamikaze_ClotThink(int iNPC)
{
...
static Action InfectedKamikaze_OnTakeDamage(int victim, int &attacker, int &inflictor, float &damage, int &damagetype, int &weapon, float damageForce[3], float damagePosition[3], int damagecustom)
{
...
static void InfectedKamikaze_NPCDeath(int entity)
{
