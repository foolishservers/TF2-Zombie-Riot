...
{
	return InfectedTomislavMain(vecPos, vecAng, team);
}

methodmap InfectedTomislavMain < CClotBody
{
	...
	public InfectedTomislavMain(float vecPos[3], float vecAng[3], int ally)
	{
		...
		func_NPCDeath[npc.index] = InfectedTomislavMain_NPCDeath;
		func_NPCOnTakeDamage[npc.index] = InfectedTomislavMain_OnTakeDamage;
		func_NPCThink[npc.index] = InfectedTomislavMain_ClotThink;
		...
		npc.m_iWearable1 = npc.EquipItem("head", "models/workshop/weapons/c_models/c_tomislav/c_tomislav.mdl");
		SetVariantString("1.0");
		AcceptEntityInput(npc.m_iWearable1, "SetModelScale");

		npc.m_iWearable2 = npc.EquipItem("head", "models/player/items/all_class/all_domination_2009_heavy.mdl");
		SetVariantString("1.0");
...
public void InfectedTomislavMain_ClotThink(int iNPC)
{
	...
	if(IsValidEnemy(npc.index, npc.m_iTarget))
	{
		...
		InfectedTomislavMainSelfDefense(npc); 
	}
	else
	{
