...
{
	return InfectedSniperjarate(vecPos, vecAng, team);
}

methodmap InfectedSniperjarate < CClotBody
{
	...
	public InfectedSniperjarate(float vecPos[3], float vecAng[3], int ally)
	{
		...
		func_NPCDeath[npc.index] = InfectedSniperjarate_NPCDeath;
		func_NPCOnTakeDamage[npc.index] = Generic_OnTakeDamage;
		func_NPCThink[npc.index] = InfectedSniperjarate_ClotThink;
