...
public void ZSMedicHealer_OnMapStart_NPC()
{
	NPCData data;
...
static void ZSMedicHealer_ClotThink(int iNPC)
{
...
static Action ZSMedicHealer_OnTakeDamage(int victim, int &attacker, int &inflictor, float &damage, int &damagetype, int &m_iWearable3, float damageForce[3], float damagePosition[3], int damagecustom)
{
...
static void ZSMedicHealer_NPCDeath(int entity)
{
