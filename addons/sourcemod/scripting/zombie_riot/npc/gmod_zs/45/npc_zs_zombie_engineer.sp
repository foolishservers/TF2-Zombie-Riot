...
public void InfectedEngineer_OnMapStart_NPC()
{
	NPCData data;
...
static void InfectedEngineer_ClotThink(int iNPC)
{
...
static Action InfectedEngineer_OnTakeDamage(int victim, int &attacker, int &inflictor, float &damage, int &damagetype, int &weapon, float damageForce[3], float damagePosition[3], int damagecustom)
{
...
static void InfectedEngineer_NPCDeath(int entity)
{
