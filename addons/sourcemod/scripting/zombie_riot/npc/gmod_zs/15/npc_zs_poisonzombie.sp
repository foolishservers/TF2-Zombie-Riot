...
{
	return ZSPoisonZombie(vecPos, vecAng, team);
}
...
public void ZSPoisonZombie_ClotThink(int iNPC)
{
...
public Action ZSPoisonZombie_OnTakeDamage(int victim, int &attacker, int &inflictor, float &damage, int &damagetype, int &weapon, float damageForce[3], float damagePosition[3], int damagecustom)
{
