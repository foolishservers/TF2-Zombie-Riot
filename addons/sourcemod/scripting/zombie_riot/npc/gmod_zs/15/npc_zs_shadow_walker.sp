...
static const char g_HurtSounds[] = "npc/antlion/pain2.wav";
...
methodmap ShadowWalker < CClotBody
{
	...
	public void PlayHurtSound() {
		...
		EmitSoundToAll(g_HurtSounds, this.index, SNDCHAN_VOICE, NORMAL_ZOMBIE_SOUNDLEVEL, _, NORMAL_ZOMBIE_VOLUME, GetRandomInt(190, 200));
	}
...
static void ShadowWalker_ClotThink(int iNPC)
{
...
static void ShadowWalker_NPCDeath(int entity)
{
